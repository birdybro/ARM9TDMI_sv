...
| ARM instruction set | PARTIAL | PARTIAL (non-PC data processing, branch execute, common multiply execute, ARMv5TE DSP multiply execute, CLZ, and saturating-arithmetic decode paths) | VERIFIED ALU/shifter/immediate/decode integration, B/BL/BX/BLX profile behavior, conditioned common/DSP multiply and CLZ writes, saturating decode, and ARMv5TE profile separation; other classes not implemented |
