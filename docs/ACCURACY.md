...
| ARM instruction set | PARTIAL | PARTIAL (condition and barrel-shifter primitives) | VERIFIED shifter amounts/boundaries; instruction decode/execute not implemented |
