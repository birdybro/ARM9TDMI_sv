...
| ARM instruction set | PARTIAL | PARTIAL (non-PC data processing, branch execute, common multiply execute, ARMv5TE DSP multiply execute, CLZ, saturating arithmetic, Addressing Modes 2/3, profile-separated LDRD/STRD decode/preparation, and single/miscellaneous transfer paths) | VERIFIED ALU/shifter/immediate/decode integration, branches, multiply/DSP/CLZ/saturating side-effect intents, Addressing Modes 2/3, ARM946E-S LDRD/STRD decode/address/request descriptors with ARM9TDMI exclusion, common single/miscellaneous request and completion intents, and load formatting; doubleword completion, external memory interfaces, cycle timing, and other classes not implemented |
