...
| ARM instruction set | PARTIAL | PARTIAL (non-PC data processing, branch execute, and common multiply execute paths) | VERIFIED ALU/shifter/immediate/decode integration, B/BL/BX/BLX profile behavior, and conditioned common multiply writes; other classes not implemented |
