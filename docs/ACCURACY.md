...
| ARM instruction set | PARTIAL | PARTIAL (non-PC data processing, branch execute, common multiply execute, ARMv5TE DSP multiply execute, CLZ, and saturating-arithmetic execute paths) | VERIFIED ALU/shifter/immediate/decode integration, B/BL/BX/BLX profile behavior, conditioned common/DSP multiply, CLZ, and saturating writes/Q requests, plus ARMv5TE profile separation; other classes not implemented |
