...
| ARM instruction set | PARTIAL | PARTIAL (non-PC data processing, branch execute, common multiply execute, and ARMv5TE DSP multiply decode paths) | VERIFIED ALU/shifter/immediate/decode integration, B/BL/BX/BLX profile behavior, conditioned common multiply writes, and profile-separated DSP multiply decode; other classes not implemented |
