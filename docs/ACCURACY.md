...
| ARM programmer-visible state | PARTIAL | PARTIAL (R0-R14, CPSR/SPSR banks, basic PC addressing, data-processing/LDR/LDM-to-PC completion, ARM9TDMI stored-PC selection, block-transfer bank/exception-return intents) | VERIFIED bank selection, PSR masks, reset fields, ordinary PC reads/writes, BX/data-processing/LDR/LDM targets, data-processing and LDM SPSR exception returns, ARM946E-S CP15 loading-TBIT control behavior, ARM9TDMI STR/STM R15 value, and LDM/STM S-bit privilege/exception-return classification; ARM946E-S stored-PC choice remains unspecified by reviewed public sources |
