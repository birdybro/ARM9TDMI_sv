...
|---|---|---:|---|---|---|
| `DDI0180A` | ARM9TDMI Technical Reference Manual, Rev 3 | 2000-03 | [Arm documentation](https://developer.arm.com/documentation/ddi0180/a) | `38fc101a671518a0361271354fd402e9df4ebcbab1e4d0b865c69cc1c32adf44` | ARM9TDMI implementation options (including stored-PC value and abort model), pipeline, Harvard interface, interlocks, cycle tables, multiplier termination, coprocessor, debug/JTAG, AC requirements |
